...
const TESTIMONIALS: Testimonial[] = [
  {
    ...
    metric: '380%',
    metricText: 'Growth in Meetings Booked',
  ...
  },
  {
    ...
    metric: 'From ₹0 to ₹50L',
    metricText: 'Revenue in 6 Months',
  ...
  },
  {
    ...
    quote: '“Shitanshu helped launch my fashion brand, Brazen Born, and we started getting orders much sooner than expected. Their strategy, audience targeting, and messaging were spot on. I’d recommend them to anyone starting a new brand.”',
    metric: 'Orders from Day 1',
    metricText: 'After Launch',
  ...
  },
  {
    ...
    quote: 'I have had the distinct pleasure of collaborating with Shitanshu on the performance marketing initiatives for Hangookd. Shitanshu\'s expertise has been crucial in expanding our online presence and increasing customer engagement. His well-crafted campaigns and innovative approach have significantly boosted our sales and visibility online. His keen analytical skills and adaptability in strategy execution have profoundly impacted our business growth. I highly recommend Shitanshu to anyone aiming to enhance their performance marketing outcomes and achieve substantial business results."',
    metric: '87%',
    metricText: 'Increase in ROAS',
  ...
  },
  {
    ...
    quote: '“Working with Shitanshu led to a clear increase in our website traffic and a noticeable drop in ad costs. Their team was highly professional, met every deadline, and maintained excellent communication throughout. Their timely support and responsiveness truly stood out.”',
    metric: '50%',
    metricText: 'Reduction in CPL',
